...
var getUrlParameter = function getUrlParameter(sParam) {
 ...
 var username = sessionStorage.getItem("username");
   ...
   $.ajax({
  type: 'post',
   //url:'http://localhost/gaame/php/getbet_bacc.php',
   url:'http://thefugen.com/lingam/jackpot/getbet_bacc.php',
  data: {
  user_id:user_ids,mobile_login:mobile_login,username:username,pos:"P",
  },
...
var getUrlParameter = function getUrlParameter(sParam) {
 ...
 var username = sessionStorage.getItem("username");
   ...
   $.ajax({
  type: 'post',
 url:'http://thefugen.com/lingam/jackpot/clearbet_bacc.php',
 //url:'http://localhost/gaame/php/clearbet_bacc.php',	
  data: {
  user_id:user_ids,mobile_login:mobile_login,username:username,pos:"P",
  },
  success: function (response) {
