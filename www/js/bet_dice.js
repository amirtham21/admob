...
var getUrlParameter = function getUrlParameter(sParam) {
 ...
 var username = sessionStorage.getItem("username");
   ...
   $.ajax({
  type: 'post',
 //url:'http://localhost/gaame/php/getbet_dice.php',
   url:'http://thefugen.com/lingam/jackpot/getbet_dice.php',
  data: {
...
var getUrlParameter = function getUrlParameter(sParam) {
 ...
 var username = sessionStorage.getItem("username");
   ...
   $.ajax({
  type: 'post',
url:'http://thefugen.com/lingam/jackpot/clearbet_dice.php',
 //url:'http://localhost/gaame/php/clearbet_dice.php',	
  data: {
  user_id:user_ids,mobile_login:mobile_login,username:username,pos:"A",
  },
  success: function (response) {
